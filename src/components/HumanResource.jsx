...
export const HumanResource = ({ isAdmin = false }) => {
  ...
  useEffect(() => {
    const storedImages =
      JSON.parse(localStorage.getItem("galleryImagesPersonas")) || [];
    if (Array.isArray(storedImages)) {
      setImages(storedImages);
    } else {
      console.warn(
        "Las imágenes almacenadas no son un array válido:",
        storedImages
      );
    }
  }, []);
